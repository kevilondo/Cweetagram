            ...
            <div class="container card card-primary card-outline">
                ...
                <form action="{{ route('device.update', $device->id) }}" method="POST">
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <input type="text" name="serial_number" class="form-control @error('serial_number') is-invalid @enderror" value='{{isset($device->serial_number) ? $device->serial_number : old('serial_number')}}'>
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <input type="text" name="password" class="form-control @error('password') is-invalid @enderror" value='{{isset($device->password) ? $device->password : old('password')}}'>
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <input type="text" name="cell_number" class="form-control @error('cell_number') is-invalid @enderror" value="{{isset($device->cell_number) ? $device->cell_number :  old('cell_number')}}">
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <select name="vehicle" id="vehicle" class="form-control @error('vehicle') is-invalid @enderror">
                            ...
                            @if ($device->vehicle)
                                <option value="{{$device->vehicle->id}}" selected>{{$device->vehicle->display_name}}</option>
                            @endif
